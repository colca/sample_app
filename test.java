...
//
// Debug information:
// Generated date: Sun May 04 17:08:32 PDT 2014
...
public class test extends SqoopRecord  implements DBWritable, Writable {
  ...
  public test with_etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public test with_publishedat(String publishedat) {
    this.publishedat = publishedat;
    return this;
  }
  ...
  public test with_channelid(String channelid) {
    this.channelid = channelid;
    return this;
  }
  ...
  public test with_thumbnailsdefault(String thumbnailsdefault) {
    this.thumbnailsdefault = thumbnailsdefault;
    return this;
  }
  ...
  public test with_thumbnailsmedium(String thumbnailsmedium) {
    this.thumbnailsmedium = thumbnailsmedium;
    return this;
  }
  ...
  public test with_thumbnailshigh(String thumbnailshigh) {
    this.thumbnailshigh = thumbnailshigh;
    return this;
  }
  ...
  public test with_thumbnailsstandard(String thumbnailsstandard) {
    this.thumbnailsstandard = thumbnailsstandard;
    return this;
  }
  ...
  public test with_channeltitle(String channeltitle) {
    this.channeltitle = channeltitle;
    return this;
  }
  ...
  public test with_youtubecategoryid(Integer youtubecategoryid) {
    this.youtubecategoryid = youtubecategoryid;
    return this;
  }
  ...
  public test with_viewcount(Integer viewcount) {
    this.viewcount = viewcount;
    return this;
  }
  ...
  public test with_likecount(Integer likecount) {
    this.likecount = likecount;
    return this;
  }
  ...
  public test with_dislikecount(Integer dislikecount) {
    this.dislikecount = dislikecount;
    return this;
  }
  ...
  public test with_favoritecount(Integer favoritecount) {
    this.favoritecount = favoritecount;
    return this;
  }
  ...
  public test with_commentcount(Integer commentcount) {
    this.commentcount = commentcount;
    return this;
  }
  ...
  public test with_embedhtml(String embedhtml) {
    this.embedhtml = embedhtml;
    return this;
  }
  ...
  public test with_title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    equal = equal && (this.publishedat == null ? that.publishedat == null : this.publishedat.equals(that.publishedat));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.publishedat = JdbcWritableBridge.readString(3, __dbResults);
    ...
    this.ratio = JdbcWritableBridge.readDouble(21, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(publishedat, 3 + __off, 12, __dbStmt);
    ...
    JdbcWritableBridge.writeDouble(ratio, 21 + __off, 8, __dbStmt);
    return 21;
  }
  public void readFields(DataInput __dataIn) throws IOException {
    ...
    this.publishedat = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.channelid = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.publishedat) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, publishedat);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(publishedat==null?"null":publishedat, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.publishedat = null; } else {
      this.publishedat = __cur_str;
    }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("publishedat", this.publishedat);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("publishedat".equals(__fieldName)) {
      this.publishedat = (String) __fieldVal;
    }
